...
| system.network.protocol.tcp.memorypressure.rate          |      global      |                                                                                                                                           pressures                                                                                                                                            |       events/s        |
| system.network.protocol.tcp.connaborts.rate              |      global      |                                                                                                                     baddata, userclosed, nomemory, timeout, linger, failed                                                                                                                     |     connections/s     |
| system.network.protocol.tcp.reorders.rate                |      global      |                                                                                                                                  timestamp, sack, fack, reno                                                                                                                                   |       packets/s       |
| system.network.protocol.tcp.ofo.rate                     |      global      |                                                                                                                                inqueue, dropped, merged, pruned                                                                                                                                |       packets/s       |
| system.network.protocol.tcp.syncookies.rate              |      global      |                                                                                                                                     received, sent, failed                                                                                                                                     |       packets/s       |
...
| system.network.protocol.icmp.ipv6.mld.v1.messages.rate   |      global      |                                                                                                         InQueries, OutQueries, InResponses, OutResponses, InReductions, OutReductions                                                                                                          |      messages/s       |
| system.network.protocol.icmp.ipv6.mld.v2.messages.rate   |      global      |                                                                                                                                         received, sent                                                                                                                                         |       reports/s       |
| system.network.protocol.icmp.ipv6.rd.rate                |      global      |                                                                                                                  InSolicits, OutSolicits, InAdvertisements, OutAdvertisements                                                                                                                  |      messages/s       |
| system.network.protocol.icmp.ipv6.nd.rate                |      global      |                                                                                                                  InSolicits, OutSolicits, InAdvertisements, OutAdvertisements                                                                                                                  |      messages/s       |
...
| system.network.fragments.reassembly.entries.ipv4.count   |      global      |                                                                                                                                             inuse                                                                                                                                              |        entries        |
| system.network.fragments.reassembly.entries.ipv6.count   |      global      |                                                                                                                                             inuse                                                                                                                                              |        entries        |
