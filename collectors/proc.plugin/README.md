...
| system.storage.device.backlog.size                               |       disk       |                                                                                                                                            backlog                                                                                                                                             |        seconds        |
...
| system.storage.device.bcache.hit.ratio                           |       disk       |                                                                                                                                    5min, 1hour, 1day, ever                                                                                                                                     |      percentage       |
...
| system.storage.device.bcache.bypass_operations.rate              |       disk       |                                                                                                                                          hits, misses                                                                                                                                          |     operations/s      |
