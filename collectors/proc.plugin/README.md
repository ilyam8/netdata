...
| system.memory.mgmt.paging.writeback.count.size                       |      global      |                                                                                                                     Dirty, Writeback, FuseWriteback, NfsWriteback, Bounce                                                                                                                      |     bytes      |
...
| system.network.device.compressed.count.rate                          |  network device  |                                                                                                                                         received, sent                                                                                                                                         |   packets/s    |
...
| system.network.protocol.tcp.memory_pressures.count.rate              |      global      |                                                                                                                                           pressures                                                                                                                                            |    events/s    |
...
| system.network.protocol.sctp.fragmentation.count.rate                |      global      |                                                                                                                                    reassembled, fragmented                                                                                                                                     |   packets/s    |
...
| system.network.fragments.reassembly.packets.ipv4.count.rate          |      global      |                                                                                                                                        ok, failed, all                                                                                                                                         |   packets/s    |
| system.network.fragments.reassembly.packets.ipv6.count.rate          |      global      |                                                                                                                                    ok, failed, timeout, all                                                                                                                                    |   packets/s    |
| system.network.fragments.reassembly.hashtable.entries.ipv4.count.num |      global      |                                                                                                                                             inuse                                                                                                                                              |    entries     |
| system.network.fragments.reassembly.hashtable.entries.ipv6.count.num |      global      |                                                                                                                                             inuse                                                                                                                                              |    entries     |
| system.network.fragments.reassembly.memory.ipv4.size.num             |      global      |                                                                                                                                             inuse                                                                                                                                              |     bytes      |
| system.network.fragments.reassembly.memory.ipv6.size.num             |      global      |                                                                                                                                             inuse                                                                                                                                              |     bytes      |
| system.network.fragments.fragmentation.packets.ipv4.count.rate       |      global      |                                                                                                                                      ok, failed, created                                                                                                                                       |   packets/s    |
| system.network.fragments.fragmentation.packets.ipv6.count.rate       |      global      |                                                                                                                                        ok, failed, all                                                                                                                                         |   packets/s    |
...
| system.network.netfilter.conntrack.ignore.count.rate                 |      global      |                                                                                                                                             ignore                                                                                                                                             |   packets/s    |
...
| system.network.netfilter.synproxy.syn.count.rate                     |      global      |                                                                                                                                            received                                                                                                                                            |   packets/s    |
...
| system.storage.device.bcache.hits.perc                               |       disk       |                                                                                                                                    5min, 1hour, 1day, ever                                                                                                                                     |   percentage   |
...
| system.storage.fs.zfs.arc_size.count.perc                            |      global      |                                                                                                                                        recent, frequent                                                                                                                                        |   percentage   |
...
| system.storage.fs.nfs.server.readaheads.count.perc                   |      global      |                                                                                                                                        10%-100%, misses                                                                                                                                        |   percentage   |
...
| system.os.oom_kills.count.rate                                       |      global      |                                                                                                                                             kills                                                                                                                                              |    kills/s     |
