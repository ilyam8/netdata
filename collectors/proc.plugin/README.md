...
|------------------------------------------------------|:--------------:|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------:|:---------------------:|
| system.ipc.sysv.semaphore_sets.semaphores.count      |     global     |                                                                                                                                           semaphores                                                                                                                                           |      semaphores       |
| system.ipc.sysv.semaphore_sets.arrays.count          |     global     |                                                                                                                                             arrays                                                                                                                                             |        arrays         |
| system.ipc.sysv.message_queues.queue.messages.count  |     queue      |                                                                                                                                            messages                                                                                                                                            |       messages        |
| system.ipc.sysv.message_queues.queue.size            |     queue      |                                                                                                                                              size                                                                                                                                              |         bytes         |
| system.ipc.sysv.shared_memory.segments.count         |     global     |                                                                                                                                            segments                                                                                                                                            |       segments        |
| system.ipc.sysv.shared_memory.size                   |     global     |                                                                                                                                              size                                                                                                                                              |         bytes         |
...
| system.network.traffic.rate                          |     global     |                                                                                                                                         received, sent                                                                                                                                         |        bits/s         |
| system.network.traffic.ipv4.rate                     |     global     |                                                                                                                                         received, sent                                                                                                                                         |        bits/s         |
| system.network.traffic.ipv6.rate                     |     global     |                                                                                                                                         received, sent                                                                                                                                         |        bits/s         |
| system.load.average1                                 |     global     |                                                                                                                                              load                                                                                                                                              |         load          |
| system.load.average5                                 |     global     |                                                                                                                                              load                                                                                                                                              |         load          |
| system.load.average15                                |     global     |                                                                                                                                              load                                                                                                                                              |         load          |
...
| system.memory.ksm.size                               |     global     |                                                                                                                              shared, unshared, sharing, volatile                                                                                                                               |         bytes         |
| system.memory.ksm.saved.ratio                        |     global     |                                                                                                                                             saved                                                                                                                                              |      percentage       |
...
| system.network.ipv4.tcp.packets.rate                 |     global     |                                                                                                                                         received, sent                                                                                                                                         |       packets/s       |
| system.network.ipv4.tcp.errors.rate                  |     global     |                                                                                                                               InErrs, InCsumErrors, RetransSegs                                                                                                                                |       packets/s       |
| system.network.ipv4.tcp.opens.rate                   |     global     |                                                                                                                                        active, passive                                                                                                                                         |     connections/s     |
| system.network.ipv4.tcp.handshakes.rate              |     global     |                                                                                                                         EstabResets, OutRsts, AttemptFails, SynRetrans                                                                                                                         |       events/s        |
