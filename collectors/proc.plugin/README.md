...
| system.memory.paging.writeback.size                      |      global      |                                                                                                                     Dirty, Writeback, FuseWriteback, NfsWriteback, Bounce                                                                                                                      |         bytes         |
...
| system.memory.management.slab.size                       |      global      |                                                                                                                                   reclaimable, unreclaimable                                                                                                                                   |         bytes         |
...
| system.network.softirq.squeezed.rate                     |      global      |                                                                                                                                            squeezed                                                                                                                                            |        times/s        |
| system.network.softirq.received_rps.rate                 |      global      |                                                                                                                                              rps                                                                                                                                               |        times/s        |
| system.network.softirq.flow_limit.rate                   |      global      |                                                                                                                                           flow_limit                                                                                                                                           |        times/s        |
...
| system.network.softirq.core.squeezed.rate                |       core       |                                                                                                                                            squeezed                                                                                                                                            |        times/s        |
| system.network.softirq.core.received_rps.rate            |       core       |                                                                                                                                              rps                                                                                                                                               |        times/s        |
| system.network.softirq.core.flow_limit.rate              |       core       |                                                                                                                                           flow_limit                                                                                                                                           |        times/s        |
