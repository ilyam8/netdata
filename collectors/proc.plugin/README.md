...
| system.memory.mgmt.paging.swap.usage                             |      global      |                                                                                                                                           free, used                                                                                                                                           |         bytes         |
...
| system.memory.mgmt.ksm.saved.ratio                               |      global      |                                                                                                                                             saved                                                                                                                                              |      percentage       |
| system.memory.mgmt.slab.size                                     |      global      |                                                                                                                                   reclaimable, unreclaimable                                                                                                                                   |         bytes         |
| system.memory.mgmt.hugepages.size                                |      global      |                                                                                                                                 free, used, surplus, reserved                                                                                                                                  |          MiB          |
| system.memory.mgmt.transparent_hugepages.size                    |      global      |                                                                                                                                 free, used, surplus, reserved                                                                                                                                  |          MiB          |
...
| system.memory.mgmt.numa.node.zone.type.size                      | node, zone, type |                                                                                                                                <i>a dimension per page size</i>                                                                                                                                |           B           |
...
| system.storage.disk.iops.rate                                    |       disk       |                                                                                                                                reads, writes, discards, flushes                                                                                                                                |     operations/s      |
| system.storage.disk.iops.time                                    |       disk       |                                                                                                                                reads, writes, discards, flushes                                                                                                                                |        seconds        |
| system.storage.disk.iops.queued.count                            |       disk       |                                                                                                                                           operations                                                                                                                                           |      operations       |
...
| system.storage.disk.iops.completion.time                         |       disk       |                                                                                                                                          read, write                                                                                                                                           |        seconds        |
| system.storage.disk.iops.service.time                            |       disk       |                                                                                                                                           operation                                                                                                                                            |        seconds        |
| system.storage.disk.iops.size                                    |       disk       |                                                                                                                                      read, write, discard                                                                                                                                      |         bytes         |
...
| system.storage.disk.bcache.iops.rate                             |       disk       |                                                                                                                              hits, misses, collisions, readaheads                                                                                                                              |     operations/s      |
...
| system.storage.md.mismatches.count                               |     md array     |                                                                                                                                             count                                                                                                                                              | unsynchronized blocks |
