...
| system.memory.mgmt.numa.node.zone.type.size                      | node, zone, type |                                                                                                                                <i>a dimension per page size</i>                                                                                                                                |         bytes         |
| system.memory.zram.size                                          |      global      |                                                                                                                                      compressed, metadata                                                                                                                                      |         bytes         |
| system.memory.zram.saved.size                                    |      global      |                                                                                                                                       savings, original                                                                                                                                        |         bytes         |
| system.memory.zram.saved.ratio                                   |      global      |                                                                                                                                       savings, original                                                                                                                                        |      percentage       |
...
| system.storage.device.bcache.allocation.ratio                    |       disk       |                                                                                                                           unused, dirty, clean, metadata, undefined                                                                                                                            |      percentage       |
...
| system.storage.fs.zfs.hash.chain.max_length.num                  |      global      |                                                                                                                                              max                                                                                                                                               |       elements        |
...
| system.storage.fs.nfs.client.calls.v2.rate                       |      global      |                                                                                                                                  <i>a dimension per call</i>                                                                                                                                   |        calls/s        |
| system.storage.fs.nfs.client.calls.v3.rate                       |      global      |                                                                                                                                  <i>a dimension per call</i>                                                                                                                                   |        calls/s        |
| system.storage.fs.nfs.client.calls.v4.rate                       |      global      |                                                                                                                                  <i>a dimension per call</i>                                                                                                                                   |        calls/s        |
...
| system.storage.fs.nfs.server.readahead.ratio                     |      global      |                                                                                                                                        10%-100%, misses                                                                                                                                        |      percentage       |
...
| system.storage.fs.nfs.server.calls.v2.rate                       |      global      |                                                                                                                                  <i>a dimension per call</i>                                                                                                                                   |        calls/s        |
| system.storage.fs.nfs.server.calls.v3.rate                       |      global      |                                                                                                                                  <i>a dimension per call</i>                                                                                                                                   |        calls/s        |
| system.storage.fs.nfs.server.calls.v4.rate                       |      global      |                                                                                                                                  <i>a dimension per call</i>                                                                                                                                   |        calls/s        |
| system.storage.fs.nfs.server.operations.v4.rate                  |      global      |                                                                                                                                <i>a dimension per operation</i>                                                                                                                                |     operations/s      |
